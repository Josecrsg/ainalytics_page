...
export const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      setFormData({ ...formData, ...data }); // Spread data correctly into formData
    };
  
    fetchListing();
  }, [params.listingId]); // You should have params.listingId as a dependency
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-6 flex-wrap'>
                    ...
                    <input type="checkbox" 
                        ...
                        className='w-5'
                        onChange={handleChange}
                        checked = {formData.parking} // Corregido aquí
                    />
