...
export const getListings = async (req, res, next) => {
    try {
      ...
      if (offer === undefined || offer === 'false') {
        offer = { $in: [false, true] }; //$in significa que busque dentro de la db tanto si es falso como verdadero
      }
      ...
      const listings = await Listing.find({
        name: { $regex: searchTerm, $options: 'i' }, //con regex busca cualquier parte del nombre no necesitan ser palabras enteras, opction i es para que no importe si es mayus o min
        offer,
        furnished,
        parking,
        type,
